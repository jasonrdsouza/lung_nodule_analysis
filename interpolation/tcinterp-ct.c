...
float      xd, yd, zd, p00, p01, p02, p03, p10, p11, p12, p13, p20, p21, p22, p23, p30, p31, p32, p33, w0, w1, w2, w3; //temp variables for linear interp
    ...
    VXmake3dim(&tc_interp, VX_PSHORT, bbx, 1);
    ...
    for (k = tc_interp.zlo+2*dz/nz; k <= tc_interp.zhi-2*dz/nz; k++){
      for (j = tc_interp.ylo+2*dy/ny; j <= tc_interp.yhi-2*dy/ny; j++){
        for (i = tc_interp.xlo+2*dx/nx; i <= tc_interp.xhi-2*dx/nx; i++){
            // remap from the new voxel space to old voxel space
            xt= i;
            yt= j;
            zt= k;
            ...
            // 8 NN pixels
            orig.s[nnz1][nny1][nnx1];
            orig.s[nnz1][nny1][nnx2];
            orig.s[nnz1][nny2][nnx1];
            orig.s[nnz1][nny2][nnx2];

            orig.s[nnz2][nny1][nnx1];
            orig.s[nnz2][nny1][nnx2];
            orig.s[nnz2][nny2][nnx1];
            orig.s[nnz2][nny2][nnx2];

            // start the interpolation caclculations
            ...
            p00= CINT(orig.s[nnz0][nny0][nnx0], orig.s[nnz1][nny0][nnx0], orig.s[nnz2][nny0][nnx0], orig.s[nnz3][nny0][nnx0], zd);
            p01= CINT(orig.s[nnz0][nny1][nnx0], orig.s[nnz1][nny1][nnx0], orig.s[nnz2][nny1][nnx0], orig.s[nnz3][nny1][nnx0], zd);
            p02= CINT(orig.s[nnz0][nny2][nnx0], orig.s[nnz1][nny2][nnx0], orig.s[nnz2][nny2][nnx0], orig.s[nnz3][nny2][nnx0], zd);
            p03= CINT(orig.s[nnz0][nny3][nnx0], orig.s[nnz1][nny3][nnx0], orig.s[nnz2][nny3][nnx0], orig.s[nnz3][nny3][nnx0], zd);
            p10= CINT(orig.s[nnz0][nny0][nnx1], orig.s[nnz1][nny0][nnx1], orig.s[nnz2][nny0][nnx1], orig.s[nnz3][nny0][nnx1], zd);
            p11= CINT(orig.s[nnz0][nny1][nnx1], orig.s[nnz1][nny1][nnx1], orig.s[nnz2][nny1][nnx1], orig.s[nnz3][nny1][nnx1], zd);
            p12= CINT(orig.s[nnz0][nny2][nnx1], orig.s[nnz1][nny2][nnx1], orig.s[nnz2][nny2][nnx1], orig.s[nnz3][nny2][nnx1], zd);
            p13= CINT(orig.s[nnz0][nny3][nnx1], orig.s[nnz1][nny3][nnx1], orig.s[nnz2][nny3][nnx1], orig.s[nnz3][nny3][nnx1], zd);
            p20= CINT(orig.s[nnz0][nny0][nnx2], orig.s[nnz1][nny0][nnx2], orig.s[nnz2][nny0][nnx2], orig.s[nnz3][nny0][nnx2], zd);
            p21= CINT(orig.s[nnz0][nny1][nnx2], orig.s[nnz1][nny1][nnx2], orig.s[nnz2][nny1][nnx2], orig.s[nnz3][nny1][nnx2], zd);
            p22= CINT(orig.s[nnz0][nny2][nnx2], orig.s[nnz1][nny2][nnx2], orig.s[nnz2][nny2][nnx2], orig.s[nnz3][nny2][nnx2], zd);
            p23= CINT(orig.s[nnz0][nny3][nnx2], orig.s[nnz1][nny3][nnx2], orig.s[nnz2][nny3][nnx2], orig.s[nnz3][nny3][nnx2], zd);
            p30= CINT(orig.s[nnz0][nny0][nnx3], orig.s[nnz1][nny0][nnx3], orig.s[nnz2][nny0][nnx3], orig.s[nnz3][nny0][nnx3], zd);
            p31= CINT(orig.s[nnz0][nny1][nnx3], orig.s[nnz1][nny1][nnx3], orig.s[nnz2][nny1][nnx3], orig.s[nnz3][nny1][nnx3], zd);
            p32= CINT(orig.s[nnz0][nny2][nnx3], orig.s[nnz1][nny2][nnx3], orig.s[nnz2][nny2][nnx3], orig.s[nnz3][nny2][nnx3], zd);
            p33= CINT(orig.s[nnz0][nny3][nnx3], orig.s[nnz1][nny3][nnx3], orig.s[nnz2][nny3][nnx3], orig.s[nnz3][nny3][nnx3], zd);
            ...
            // X direction
            tc_interp.s[zt][yt][xt]= CINT(w0, w1, w2, w3, xd);
	    }
      }
    }
